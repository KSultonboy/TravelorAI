      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            ...
            "Pul qaytarish uchun ariza " + CONTACT.email + " manziliga yoki " + CONTACT.phone + " raqamiga yuboriladi. Arizada to'lov sanasi, summasi va usuli ko'rsatiladi.",
        ...
        },
        {
          ...
          body: [
            ...
            "Har qanday savol yoki murojaat uchun: " + CONTACT.phone + " · " + CONTACT.email + " · " + CONTACT.telegram,
          ],
        },
        {
