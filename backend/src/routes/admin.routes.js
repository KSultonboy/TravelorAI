...
router.get('/payments-overview', billing.getPaymentsOverview);
router.get('/click-transactions', billing.getClickTransactions);
router.get('/user-payments', billing.getUserPayments);
